#include <iostream>
	...
	{
	    assert(0x0 <= i && i <= 0xf);//путем защитного программирования
	    char digits[] = "0123456789abcdef";
	    return digits[i];
	}
	//извлекает старшие и младшие nobble и маска
	void
	print_in_hex (uint8_t byte)
	{
	    cout << nibble_to_hex(byte >> 4)//смещение на 4 разряда
	...
	const uint8_t*
	as_bytes(const void* data)//преобразование
	{
